...
ping_date : deniz altında gözlemlenen uğultuların tarihi. 

ping_time : deniz altında gözlemlenen uğultuların saati. 

ping_milliseconds : deniz altında gözlemlenen uğultuların kaç milisaniye boyunca sürdüğü. 

latitude : enlem. 

longitude : boylam.

position_status : pozisyon durumu.

depth : derinlik.

line_status : hat durumu. 

ping_status : uğultu durumu. 
...
rota çizgisi boyunca deniz tabanının derinliğinin bir grafiği bize Shelf Break'ın konumunu gösterecektir. İzleme hattı verilerinin uzamsal analizinde, genellikle sp ve sf paketlerinde çalışırdık, ancak bu kendi başına bir konudur. Şimdilik, rota çizgisi boyunca enlem, boylam, derinlik ve mesafe ile birkaç rota çizgisi grafiği oluşturacağız.
...
GitHub Linki : https://github.com/yaseminhzrc/BaliklarNerede
